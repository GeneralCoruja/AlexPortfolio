...
document.addEventListener('click', event => {
    var isClickInside = document.getElementsByClassName('navbar').contains(event.target);
...
<template>
    <div class="navbar">
        <div class="navbar-content">
            <p class="menu-button txt-button" @click="enableMenu()">Menu</p>
            <router-link class="navbar-button txt-button" :to="{ name: 'home'}">Home</router-link>
            <router-link class="navbar-button txt-button" :to="{ name: 'about'}">About</router-link>
            <router-link class="navbar-button txt-button" :to="{ name: 'uiux'}">UI/UX</router-link>
            <router-link class="navbar-button txt-button" :to="{ name: 'logos'}">Logos</router-link>
            <a class="navbar-button txt-button" id="navbar-contact-me" href="https://www.linkedin.com/in/alexandre-mendes-uiux">Contact me</a>
        </div>
        <div class="more">
            <div class="bar"></div>
            <p>More</p>
